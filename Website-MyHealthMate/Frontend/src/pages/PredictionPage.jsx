...
export function PredictionPage() {
  ...
  const calculateResult = async () => {
    ...
    try {
      ...
      // Call API to create prediction (chỉ gửi 8 chỉ số y tế, không gửi triệu chứng)
      const predictionData = {
        ...inputData,
        // Lưu symptom scores vào notes để tham khảo (optional)
        notes: Object.keys(symptomScores).length > 0 
          ? `Điểm triệu chứng: ${JSON.stringify(symptomScores)}` 
          : undefined,
      };

    ...
    <div className="relative min-h-screen bg-gradient-to-b from-green-50 to-white py-12">
      ...
      <div className="container mx-auto px-4 max-w-6xl">
        <div className="mb-8">
          ...
          <p className="text-gray-600">Xem lại các kết quả dự đoán trước đây</p>
        </div>
        ...
        {filteredHistory.length > 0 ? (
          ...
          <Card className="p-12 rounded-2xl shadow-lg text-center">
            ...
            <p className="text-gray-600 mb-6">Bạn chưa thực hiện dự đoán nào. Hãy bắt đầu ngay!</p>
            <Button onClick={() => navigate('/prediction')} className="bg-green-600 hover:bg-green-700">Bắt đầu dự đoán</Button>
          </Card>
        )}
        ...
        {history.length > 0 && (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
            <Card className="p-6 rounded-2xl shadow-lg">
              <div className="text-gray-600 mb-2">Tổng số dự đoán</div>
              <div className="text-3xl text-gray-800">{history.length}</div>
            </Card>
            <Card className="p-6 rounded-2xl shadow-lg">
              <div className="text-gray-600 mb-2">Dự đoán gần nhất</div>

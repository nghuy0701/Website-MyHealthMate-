  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-b from-green-50 to-white py-12">
      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        {/* Patient Info */}
        {prediction.patientId && prediction.patientId.displayName && (
          <Card className="p-6 rounded-2xl shadow-lg mb-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <p className="font-medium">{prediction.patientId._id}</p>
              </div>
              <div>
                <span className="text-gray-600">Họ tên:</span>
                <p className="font-medium">{prediction.patientId.displayName}</p>
              </div>
              {prediction.patientId.email && (
                <div>
                  <span className="text-gray-600">Email:</span>
                  <p className="font-medium">{prediction.patientId.email}</p>
                </div>
              )}
              {prediction.patientId.phone && (
                <div>
                  <span className="text-gray-600">Số điện thoại:</span>
                  <p className="font-medium">{prediction.patientId.phone}</p>
                </div>
              )}
            </div>
          </Card>
